...
//here is the weather screen code
// import React, { useState } from "react";
// import {
//   View,
//   Text,
...
import api from '../services/api';// Replace with your API utility
...
const WeatherScreen = ({ navigation }) => {
  ...
  const fetchUserData = async () => {
    ...
    const city = response.data?.data?.address?.city || '';
    // console.log("City from user data:", city);
    // console.log("Address object:", response.data?.data?.address);
